...
global.kontak2 = [
[owner[0], await conn.getName(owner[0] + '6289689075040@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'yuuxdrestapi@gmail.com', true],
// [owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'f10909143@gmail.com', true],
]
